 ...
 * 整理エラーの種類
 */
export declare enum OrganizationErrorType {
...
export declare class OrganizationError extends Error {
    readonly type: OrganizationErrorType;
    readonly message: string;
    readonly filePath?: string;
    readonly environment?: Environment;
    readonly originalError?: Error;
    constructor(type: OrganizationErrorType, message: string, filePath?: string, environment?: Environment, originalError?: Error);
}
/**
 * 部分的な型（一部のプロパティのみ必須）
 */
